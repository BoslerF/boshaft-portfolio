              ...
              >
                <AnimatePresence initial={false} custom={direction}>
                  <motion.img 
                    ...
                    className="absolute w-full h-full object-cover grayscale mix-blend-multiply cursor-zoom-in active:cursor-grabbing"
                  />
                </AnimatePresence>
              </motion.div>
            )}
          ...
          >
            ...
            {images.length > 1 && (
              <>
                ...
                <button onClick={nextImage} className="hidden md:block absolute right-8 top-1/2 -translate-y-1/2 text-white/20 hover:text-white transition-colors text-6xl px-4 py-8 z-[1000] cursor-pointer">
                  ›
                </button>
              </>
            )}
